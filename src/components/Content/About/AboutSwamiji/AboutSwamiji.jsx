import meditationPic from '../../../../assets/images/Meditation.jpeg';
import sanyasaDeekshaPic from '../../../../assets/images/Sanyasa Deeksha.jpeg';
import beautifulHimalayasPic from '../../../../assets/images/Beautiful Himalayas.jpeg';
      ...
      <div className={classes.PageContainer}>
          <div className={classes.AboutSwamiji}>
            <div className={classes.SwamijiArticle}>
              <img src={meditationPic} alt="Meditation" className={classes.Image} />
              <div>
          ...
          <div className={classes.SwamijiArticle}>
            ...
            <img src={sanyasaDeekshaPic} alt="Sanyasa Deeksha" className={classes.Image} />
          </div>

          <div className={classes.SwamijiArticle}>
            <img src={beautifulHimalayasPic} alt="Beautiful Himalayas" className={classes.Image} />
